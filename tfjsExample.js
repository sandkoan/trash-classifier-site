...
var ImageModel = /** @class */ (function () {
    ...
    ImageModel.prototype.predict = function (image) {
        ...
        if (!!this.model) {
            ...
            var reshapedImage = normalizedImage.reshape(__spreadArrays([
                1
            ...
            if (imgHeight != imgWidth) {
                ...
                top_1 = (imgHeight - size) / 2 / imgHeight;
                right = (imgWidth + size) / 2 / imgWidth;
                bottom = (imgHeight + size) / 2 / imgHeight;
            }
            var croppedImage = tf.image.cropAndResize(reshapedImage, [[top_1, left, bottom, right]], [0], [this.height, this.width]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    model = new ImageModel("./model/signature.json");
...
function classify() {
    ...
    // if (args.length !== 1) {
    //   console.log(
    //     `Please specify one argument - the path to your image. Found args: ${args}`
    //   );
    //   process.exit();
    // }
    // const imgPath = document.getElementById("file")[0];
